"""
Django settings for softorks project.
...
MIDDLEWARE = [
    ...
    "softorks.locale.LanguageMiddleware",
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "softorks.context_processors.current_version",
            ],
        },
    },
]

WSGI_APPLICATION = "softorks.wsgi.application"
...
DATABASES = {
    "default": {
        ...
        "NAME": Path(os.getenv("DATABASE_NAME")),  # type: ignore[arg-type]
    }
}
